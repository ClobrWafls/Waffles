...
import net.mcreator.waffles.procedures.BungomonEntityDiesProcedure;
import net.mcreator.waffles.item.BungaloIngutItem;
...
public class BungomonEntity extends WafflesModElements.ModElement {
	public static EntityType entity = null;
	public BungomonEntity(WafflesModElements instance) {
		super(instance, 46);
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("waffles:textures/summer-spring_skin.png");
				}
			};
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(BungaloIngutItem.block, (int) (1)));
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				BungomonEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
		...
		protected void registerAttributes() {
			...
			if (this.getAttribute(SharedMonsterAttributes.MAX_HEALTH) != null)
				this.getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(54);
			if (this.getAttribute(SharedMonsterAttributes.ARMOR) != null)
				this.getAttribute(SharedMonsterAttributes.ARMOR).setBaseValue(7);
			...
			this.getAttribute(SharedMonsterAttributes.ATTACK_KNOCKBACK).setBaseValue(100D);
		}
	}
}
